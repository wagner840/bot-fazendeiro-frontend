...
export function CreateEncomendaModal({
  isOpen,
  onClose,
  encomendaForm,
  onFormChange,
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Nova Encomenda" size="lg">
      <div className="space-y-4">
        ...
        <ModalFooter className="flex-col-reverse sm:flex-row">
          ...
          <Button onClick={onCreate} isLoading={isSaving} leftIcon={<Plus size={16} />} className="w-full sm:w-auto">
            Criar Encomenda
          </Button>
        </ModalFooter>
      </div>
